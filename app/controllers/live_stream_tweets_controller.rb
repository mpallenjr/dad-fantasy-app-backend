class LiveStreamTweetsController < ApplicationController
  ...
  #This was pulled from the twitter API documentation.  Provides a "portal" for the live tweet stream.  There is code added at like 133 that adds the logic for parsing/encoding and sending to the output text file.
